...
const steps = [
    { id: '01', name: 'Configuration', href: '#/getting-started', status: 'complete' },
    { id: '02', name: 'Plan', href: '#/getting-started', status: 'current' },
    { id: '03', name: 'Take Off', href: '#/getting-started', status: 'upcoming' },
]
const Onboarding = () => {
    return (
